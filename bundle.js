...
/***/ function(module, exports, __webpack_require__) {
	...
	var _book_list_navigator = __webpack_require__(201);

	var _book_list_navigator2 = _interopRequireDefault(_book_list_navigator);

	var _book_detail = __webpack_require__(203);
	...
	var App = function (_Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            //if (this.props.activeBook === null && this.props.books.length !== 0) {
	            //    this.props.selectBook(this.props.books[this.props.bookIndex]);
	            //}
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_book_list_navigator2.default, { side: 'left' }),
	                _react2.default.createElement(_book_detail2.default, null),
	                _react2.default.createElement(_book_list_navigator2.default, { side: 'right' })
	            );
	        }
	    }]);
	...
	//    return {books: state.books, activeBook: state.activeBook, bookIndex: state.bookIndex};
	//}
	//
	...
	exports.default = (0, _reactRedux.connect)(null, { setBookList: _index.setBookList })(App);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    _createClass(BookList, [{
	        ...
	        value: function isAvailable() {
	            if (this.props.side === "left") {
	                return this.props.bookIndex === 0;
	            } else {
	                return this.props.books.list.length - 1 === this.props.bookIndex;
	            }
	        }
	    }, {
	        key: 'changeBook',
	        value: function changeBook() {
	            if (this.props.side === "left") {
	                return this.props.bookIndex - 1;
	            } else {
	                return this.props.bookIndex + 1;
	            }
	        }
	        ...
	        value: function renderButton() {
	            ...
	            var isButtonAvailable = this.isAvailable();
	            return _react2.default.createElement(
	                'button',
	                { className: 'btn btn-primary col-sm-2 ' + (isButtonAvailable ? 'disabled' : ''),
	                    onClick: isButtonAvailable ? function () {} : function () {
	                        _this2.props.setBookIndex(_this2.changeBook());
	                        _this2.props.selectBook(_this2.props.books.list[_this2.props.books.bookIndex]);
	                    } },
	                this.props.side
	            );
	        }
	...
	function mapDispatchToProps(dispatch) {
	    return (0, _redux.bindActionCreators)({ selectBook: _index.selectBook, setBookIndex: _index.setBookIndex }, dispatch);
	}
...
/***/ function(module, exports) {
	...
	exports.setBookIndex = setBookIndex;
	exports.setBookList = setBookList;
	var BOOK_SELECTED = exports.BOOK_SELECTED = 'BOOK_SELECTED';
	var NEW_BOOK_INDEX = exports.NEW_BOOK_INDEX = 'NEW_BOOK_INDEX';
	var NEW_BOOK_LIST = exports.NEW_BOOK_LIST = 'NEW_BOOK_LIST';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BookDetail = function (_Component) {
	    ...
	    _createClass(BookDetail, [{
	        key: 'render',
	        value: function render() {
	            if (!this.props.books || !this.props.books.activeBook && this.props.books.list.length === 0) {
	                return _react2.default.createElement(
	                    'div',
	                    null,
	                    ' No books to display '
	            ...
	            var activeBook = this.props.books.activeBook;
	            return _react2.default.createElement(
	                'div',
	                { className: 'col-sm-8' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducer_books = __webpack_require__(205);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	    ...
	    switch (action.type) {
	        case _index.BOOK_SELECTED:
	            return _extends({}, state, { activeBook: action.payload });
	        case _index.NEW_BOOK_INDEX:
	            return _extends({}, state, { bookIndex: action.payload });
	        case _index.NEW_BOOK_LIST:
	            return _extends({}, state, { list: action.payload.books, activeBook: action.payload.books[0], bookIndex: 0 });
	    }
	    return state;
	};
	...
	var INITIAL_STATE = { activeBook: null, bookIndex: 0, list: [] }; //todo
